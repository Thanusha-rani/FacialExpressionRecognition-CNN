...
def build_cnnmodel():
        ...
        train_dir = '..\FER_CNN\dataset\\train'
        val_dir = '..\FER_CNN\dataset\\test'
        ...
        # save model
        if os.path.exists("..\FER_CNN\models\cnn_model.hdf5"):
                pass

        else:
                emotion_model.save("..\FER_CNN\models\cnn_model.hdf5")
